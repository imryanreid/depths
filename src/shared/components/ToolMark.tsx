...
const FIGURES: Record<string, React.ReactNode> = {
  ...
  // diagonal offset being the z-axis the tool is about. Deepest darkest,
  // painted back to front, so the front-left square reads as the raised one.
  // Same shape as depths.studio/favicon.svg, generated by that repo's
  // scripts/build-icons.py — change one, change both.
  //
  // Ramps is horizontal bars, Beeps vertical bars, Springs a coil; planes are
  // a fourth kind of object at a glance, and the diagonal rhymes with the
  // direction a shadow falls.
  depths: (
    <>
      <rect x="14" y="14" width="12" height="12" rx="2" fill="#2452b0" />
      <rect x="10" y="10" width="12" height="12" rx="2" fill="#3d7dff" />
      <rect x="6" y="6" width="12" height="12" rx="2" fill="#8db0ff" />
    </>
  ),
